# AGENTS.md — Moto On/Off

> Repository guide for Codex. Read this **before** writing or modifying anything in this project. Keep responses aligned with the constraints, conventions, and priorities below.
...
**Always consult that document before building any UI component.** When this `AGENTS.md` and the design system disagree, the design system wins on visual matters and this file wins on architectural matters.
...
## 13. What Codex Should Do (and Not Do)
